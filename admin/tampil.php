...
<html>
  <head>
    ...
    <title>Page <?php echo ucfirst($_GET['menu']); ?> </title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../index2.html" class="logo">
          ...
          <span clas="logo-mini"><b>Halaman</b> Admin</span>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="tampil.php?menu=bukutamu"><i class="fa fa-circle-o text-red"></i> <span>Buku Tamu </span></a></li>
      ...
      <div class="content-wrapper">
          ...
          <div class="box">
            <div class="box-header with-border" align="center">
			  ...
			  Selamat Datang : <b><?php echo $_SESSION['admin']; ?></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
