          ...
          <div class="box">
            ...
            <div class="box-header with-border">
			  ...
			  <div class="form-group">
                    <label>Kelas</label>
                    <form role="form"action='tampil.php?menu=cetak_nilai' method="POST" >		  
<?php
...
?>
                      <tr>
						...
						<td><?php echo $tampil['nama_lengkap']; ?></td>
                      	<td><a href="./cetak.php?menu=cetak_nilai&id=<?php echo $tampil['id_nilai']; ?>" target="_blank" ><button  class="btn btn-info ">Cetak</button></a></td>
					  </tr>
<?php
		$no++;		
