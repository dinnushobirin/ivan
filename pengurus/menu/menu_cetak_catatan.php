<!-- Content Header (Page header) -->
        <section class="content-header">
          <center><h3>
            Menu
            <small>Cetak Catatan Siswa</small>
          </h3></center>
        </section>
...
?>
                      <tr>
						...
						<td><?php echo $tampil['nama_lengkap']; ?></td>
                      	<td><a href="./cetak.php?menu=cetak_catatan&id=<?php echo $tampil['id_nilai']; ?>" target="_blank" ><button  class="btn btn-info ">Cetak</button></a></td>
					  </tr>
<?php
		$no++;		
