          ...
          <div class="box">
            ...
            <div class="box-header with-border">
			  ...
			  <div class="form-group">
                    <label>Kelas</label>
                    <form role="form"action='tampil.php?menu=cetak_catatan' method="POST" >		  
<?php
	...
	$ambilg	= mysql_query("SELECT * FROM kelas k JOIN guru g ON k.nip=g.nip AND g.nip='$_SESSION[nip]'");
...
?>		
			  <select class="form-control select2"  style="width: 100%;" id="id_kelas" name="id_kelas" onChange='this.form.submit()' required="">
...
?>
                      <tr>
						...
						<td><?php echo $tampil['nama_lengkap']; ?></td>
                      	<td><a href="./cetak.php?menu=cetak_cover_siswa&id=<?php echo $tampil['id_nilai']; ?>" target="_blank" ><button  class="btn btn-info ">Cetak</button></a></td>
					  </tr>
<?php
		$no++;		
